...
!!! warning
    ⚠️ **Dependencies for netcdf-c.** It needs `libcurl` and `m4` headers. You installed these in §2 (`libcurl4-openssl-dev m4`). If a configure step complains about curl or m4, install them and re-run that library.